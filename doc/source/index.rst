...
``PyAnnote`` was started in 2012 by Herve Bredin (bredin@limsi.fr) in the framework of the `REPERE challenge <http://www.defi-repere.fr/>`_, focusing on audiovisual people recognition in TV videos.
