...
class Annotation(object):
    ...
    uri : string, optional
        name of (audio or video) annotated resource
    ...
    Examples
    --------
        >>> annotation = Annotation(uri='MyVideo')
        >>> print annotation.uri
        MyVideo
    
    """
    def __init__(self, multitrack=True, uri=None, modality=None):
        ...
        self.__timeline = Timeline(uri=self.uri)
    ...
    def __set_uri(self, uri):
        self.__uri = uri
        self.__timeline.uri = uri
        for label in self.__label_timeline:
            self.__label_timeline[label].uri = uri
    uri = property(fget=__get_uri, fset=__set_uri)
    """Path to (or any identifier of) annotated resource
    
    Examples
    --------
        >>> annotation = Annotation(uri="MyVideo.avi")
        >>> print annotation.uri
        MyVideo.avi
    ...
    def __setitem__(self, key, label):
        ...
        if label not in self.__label_timeline:
            self.__label_timeline[label] = Timeline(uri=self.uri)
    ...
    def empty(self):
        ...
        --------
            ...
            >>> annotation = Annotation(multitrack=True, uri="MyVideo.avi")
            >>> annotation[Segment(0, 2), 'speaker1'] = 'Bernard'
            >>> annotation[Segment(0, 2), 'speaker2'] = 'John'  
            >>> annotation[Segment(3, 4), 'speaker1'] = 'Albert'
    ...
    def smooth(self):
        ...
        M = Annotation(multitrack=True, 
                       uri=self.uri, modality=self.modality)
