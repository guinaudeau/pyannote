...
class ConfusionError(object):
    ...
    reference = property(fget=__get_reference, doc="Reference")
    hypothesis = property(fget=__get_hypothesis, doc="Hypothesis")
...
class Diff(object):
    ...
    def __init__(self, matcher=None):
        ...
        if matcher:
            ...
            self.__matcher = UnknownIDMatcher()
    ...
    def __call__(self, reference, hypothesis, df=False):
        ...
        inventory = Annotation(uri=reference.uri, modality=reference.modality)
